...
/* Layout */
.sidebar{width:250px;min-height:100vh;background:#0f172a;position:fixed;left:0;top:0;z-index:70;transition:transform .3s;display:flex;flex-direction:column}
...
/* Nav */
.nav-item{display:flex;align-items:center;gap:10px;padding:10px 16px;border-radius:10px;cursor:pointer;color:#94a3b8;font-size:14px;font-weight:500;transition:all .2s;margin:2px 8px;text-decoration:none}
...
.modal-box{background:white;border-radius:16px;width:100%;max-width:600px;max-height:90vh;overflow-y:auto}
.modal-header{padding:20px 24px 16px;border-bottom:1px solid #f1f5f9;position:sticky;top:0;background:white;z-index:10;border-radius:16px 16px 0 0}
...
/* Mobile bottom nav */
.bottom-nav{display:none;position:fixed;bottom:0;left:0;right:0;background:#0f172a;z-index:60;border-top:1px solid rgba(255,255,255,.08);padding:6px 0}
